...
public abstract class AbstractCoreDaoSpringTest extends AbstractDaoSpringTest {
    ...
    protected void initCommonData(TestEntityManager entityManager) {
        entityManager.persist(new RefDataEntity("key1", "value1", "This Is Label 1", 1));
        entityManager.persist(new RefDataEntity("key1", "value2", "This Is Label 2", 2));
        ...
        entityManager.persist(new RefDataEntity("key2", "value1", "This Is Label 1", 1));
        entityManager.persist(new RefDataEntity("key2", "value2", "This Is Label 2", 2));
        entityManager.persist(new RefDataEntity("key1", "value4", "This Is Label 4", 4));
